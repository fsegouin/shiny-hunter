...
# National Pokédex number → canonical lowercase name (1–251).
# Gen 2 species bytes ARE Pokédex numbers (data/pokemon/names.asm in
# pret/pokecrystal follows dex order).
GEN2_SPECIES_NAMES: dict[int, str] = {
    ...
    121: "starmie", 122: "mr_mime", 123: "scyther", 124: "jynx",
    ...
    248: "tyranitar", 249: "lugia", 250: "ho_oh", 251: "celebi",
}
